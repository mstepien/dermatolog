...
The Google Health MedSigLIP  model used in this application (including MedSigLIP) are part of the **Health AI Developer Foundations (HAI-DEF)**. Their use is subject to the [Health AI Developer Foundations Terms of Use](https://developers.google.com/health-ai-developer-foundations/terms).
